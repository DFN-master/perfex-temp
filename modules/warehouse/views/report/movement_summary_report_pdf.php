	...
	foreach ($goods_transaction_details as $main_warehouse_id => $item_by_warehouse) {
		...
		foreach ($item_by_warehouse as $key => $transaction_detail) {
			...
			if($transaction_index == 0 || ($old_warehouse_id != $main_warehouse_id)){
				...
				$items .= '<tr height="30" bgcolor="' . get_option('pdf_table_heading_color') . '" style="color:' . get_option('pdf_table_heading_text_color') . ';' . $table_font_size . '; ">';
				$items .= '
				<th rowspan="2" align="left" width="5%"><strong style="vertical-align:middle;">' . _l('wh_item_code') . '</strong></th>
				<th rowspan="2" align="left" width="11%"><strong>' . _l('description') . '</strong></th>
				<th rowspan="2" align="left" width="6%"><strong>' . _l('wh_item_type') . '</strong></th>
				<th rowspan="2" align="left" width="5%"><strong>' . _l('wh_group') . '</strong></th>
				<th rowspan="2" align="left" width="5%"><strong>' . _l('wh_sub_group') . '</strong></th>
				<th rowspan="2" align="left" width="4%"><strong>' . _l('wh_uom') . '</strong></th>
				<th rowspan="2" align="left" width="7%"><strong>' . _l('wh_batch_no') . '</strong></th>
				<th rowspan="2" align="left" width="7%"><strong>' . _l('wh_serial_hashtag') . '</strong></th>
				<th rowspan="2" align="left" width="7%"><strong>' . _l('expiry_date') . '</strong></th>
				<th rowspan="2" align="center" width="4%"><strong>' . _l('wh_b_f') . '</strong></th>
				<th colspan="5" align="center" width="12%"><strong>' . _l('wh_als_purchase') . '</strong></th>
				<th colspan="6" align="center" width="12%"><strong>' . _l('als_sales') . '</strong></th>
				<th colspan="4" align="center" width="10%"><strong>' . _l('wh_als_inventory') . '</strong></th>
				<th rowspan="2" align="right" width="5%"><strong>' . _l('wh_bal_qty') . '</strong></th>

				</tr>

				<tr  bgcolor="' . get_option('pdf_table_heading_color') . '" style="color:' . get_option('pdf_table_heading_text_color') . ';' . $table_font_size . '; ">
				<td align="right"><strong>' . _l('wh_gr') . '</strong></td>
				<td align="right"><strong>' . _l('wh_pi') . '</strong></td>
				<td align="right"><strong>' . _l('wh_cp') . '</strong></td>
				<td align="right"><strong>' . _l('wh_pr') . '</strong></td>
				<td align="right"><strong>' . _l('wh_grt') . '</strong></td>
				<td align="right"><strong>' . _l('wh_do') . '</strong></td>
				<td align="right"><strong>' . _l('wh_si') . '</strong></td>
				<td align="right"><strong>' . _l('wh_cs') . '</strong></td>
				<td align="right"><strong>' . _l('wh_drt') . '</strong></td>
				<td align="right"><strong>' . _l('wh_srt') . '</strong></td>
				<td align="right"><strong>' . _l('wh_br') . '</strong></td>
				<td align="right"><strong>' . _l('wh_stf') . '</strong></td>
				<td align="right"><strong>' . _l('wh_adj') . '</strong></td>
				<td align="right"><strong>' . _l('wh_rec') . '</strong></td>
				<td align="right"><strong>' . _l('wh_iss') . '</strong></td>
				</tr>
				</thead>
			...
			if (isset($import_openings[$main_warehouse_id][$transaction_detail['commodity_id']]) && count($import_openings[$main_warehouse_id][$transaction_detail['commodity_id']]) > 0) {
				foreach ($import_openings[$main_warehouse_id][$transaction_detail['commodity_id']] as $lot_date => $import_opening) {
					...
					if(!$exist_data){
						...
						$items .= '<td align="left" width="11%"><span style="font-weight:bold;">' . $transaction_detail['description'] . '</span></td>';
					...
					$items .= '<tr style="' . $table_font_size . '">';
					$items .= '<td width="5%"></td>';
					$items .= '<td width="11%"></td>';
					$items .= '<td width="6%"></td>';
					$items .= '<td width="5%"></td>';
					$items .= '<td width="5%"></td>';
					$items .= '<td width="4%"></td>';
					$items .= '<td width="7%">' . $import_opening['lot_number'] . '</td>';
					$items .= '<td width="7%">' . $import_opening['serial_number'] . '</td>';
					$items .= '<td width="7%">' . $import_opening['expiry_date'] . '</td>';
					...
					$items .= '<td align="right" width="2.4%">'. app_format_number($gr, '') .'</td>';
					$items .= '<td align="right" width="2.4%">'. app_format_number($pi, '') .'</td>';
					$items .= '<td align="right" width="2.4%">'. app_format_number($cp, '') .'</td>';
					$items .= '<td align="right" width="2.4%">'. app_format_number($pr, '') .'</td>';
					$items .= '<td align="right" width="2.4%">'. app_format_number($grt, '') .'</td>';

					$items .= '<td align="right" width="2%">'. app_format_number($do, '') .'</td>';
					$items .= '<td align="right" width="2%">'. app_format_number($si, '') .'</td>';
					$items .= '<td align="right" width="2%">'. app_format_number($cs, '') .'</td>';
					$items .= '<td align="right" width="2%">'. app_format_number($drt, '') .'</td>';
					$items .= '<td align="right" width="2%">'. app_format_number($srt, '') .'</td>';
					$items .= '<td align="right" width="2%">'. app_format_number($br, '') .'</td>';
			...
			if (isset($import_period_openings[$main_warehouse_id][$transaction_detail['commodity_id']]) && count($import_period_openings[$main_warehouse_id][$transaction_detail['commodity_id']]) > 0) {
				foreach ($import_period_openings[$main_warehouse_id][$transaction_detail['commodity_id']] as $lot_date => $import_period_details) {
					...
					// $items .= '<td colspan="1"></td>';
						...
						$items .= '<td colspan="1" width="11%"></td>';
						$items .= '<td colspan="1" width="6%"></td>';
						$items .= '<td colspan="1" width="5%"></td>';
						$items .= '<td colspan="1" width="5%"></td>';
						$items .= '<td colspan="1" width="4%"></td>';
						$items .= '<td colspan="1" width="7%">'. $import_period_opening['lot_number'] .'</td>';
						$items .= '<td colspan="1" width="7%">'. $import_period_opening['serial_number'] .'</td>';
						$items .= '<td colspan="1" width="7%">'. $import_period_opening['expiry_date'] .'</td>';
			...
			if($exist_data){
				...
				$items .= '<td colspan="1" class="bold" align="right" width="2.4%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($gr_subtotal, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2.4%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($pi_subtotal, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2.4%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($cp_subtotal, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2.4%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($pr_subtotal, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2.4%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($grt_subtotal, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($do_subtotal, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($si_subtotal, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($cs_subtotal, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($drt_subtotal, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($srt_subtotal, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($br_subtotal, '') . '</span></td>';
			...
			if(count($item_by_warehouse) == $total_item_by_warehouse){
				...
				$items .= '<td colspan="1" class="bold" align="right" width="2.4%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($gr_total, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2.4%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($pi_total, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2.4%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($cp_total, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2.4%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($pr_total, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2.4%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($grt_total, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($do_total, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($si_total, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($cs_total, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($drt_total, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($srt_total, '') . '</span></td>';
				$items .= '<td colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($br_total, '') . '</span></td>';
		...
		if($total_warehouse == count($goods_transaction_details)){
			...
			$items .= '<th colspan="1" class="bold" align="right" width="2.4%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($gr_grandtotal, '') . '</span></th>';
			$items .= '<th colspan="1" class="bold" align="right" width="2.4%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($pi_grandtotal, '') . '</span></th>';
			$items .= '<th colspan="1" class="bold" align="right" width="2.4%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($cp_grandtotal, '') . '</span></th>';
			$items .= '<th colspan="1" class="bold" align="right" width="2.4%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($pr_grandtotal, '') . '</span></th>';
			$items .= '<th colspan="1" class="bold" align="right" width="2.4%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($grt_grandtotal, '') . '</span></th>';
			$items .= '<th colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($do_grandtotal, '') . '</span></th>';
			$items .= '<th colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($si_grandtotal, '') . '</span></th>';
			$items .= '<th colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($cs_grandtotal, '') . '</span></th>';
			$items .= '<th colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($drt_grandtotal, '') . '</span></th>';
			$items .= '<th colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($srt_grandtotal, '') . '</span></th>';
			$items .= '<th colspan="1" class="bold" align="right" width="2%" style="border-top: 1px hair black !important; border-bottom: 1.5px hair black !important;"><span style="font-weight:bold;">' . app_format_number($br_grandtotal, '') . '</span></th>';
