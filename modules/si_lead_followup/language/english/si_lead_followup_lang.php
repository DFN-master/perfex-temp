...
$lang['si_lfs_schedule_send_title_info'] = 'Create Schedule for Leads to take followup remainder by sending SMS/Email to Lead\'s contact number.';
...
$lang['si_lfs_sent_error_message'] = 'No contacts found having valid phone number or Email to send';
$lang['si_lfs_schedule_add'] = 'Add Schedule';
...
$lang['si_lfs_schedule_days_info_note'] = 'This scheduler will run everyday at specified schedule Hour. <br/>SMS/Email will be triggered only for that leads which are created before specified Days of Auto send Reminder and having Lead starus and source as per selected in this schedule';
$lang['si_lfs_schedule_hour'] = 'Schedule Hour';
$lang['si_lfs_schedule_last_executed'] = 'Last Executed';
$lang['si_lfs_schedule_error_message'] = 'There is some issue in saving the Schedule';
$lang['si_lfs_schedule_success_activity_log_text'] 	= '%s Lead follow up Schedule executed';
$lang['si_lfs_select_atleast_one'] = 'Select Send SMS or Email';