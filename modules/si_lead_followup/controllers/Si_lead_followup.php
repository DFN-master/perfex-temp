...
class Si_lead_followup extends AdminController 
{
	...
	function index()
	{
		...
		$template_name = 'si_lead_followup_lead_followup_email';
        $data = si_lead_followup_prepare_mail_preview_data($template_name, 1,['si_lead_followup']);
	...
	function validate()
	{
		...
		try{
			...
			echo si_lfo_execute_result($result);
		}
		catch (Exception $e) {
