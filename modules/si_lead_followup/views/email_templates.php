...
<div class="col-md-12">
    <h4 class="bold well email-template-heading">
        <?php echo _l('si_lead_followup'); ?>
        <?php if ($hasPermissionEdit) { ?>
            <a href="<?php echo admin_url('emails/disable_by_type/si_lead_followup'); ?>" class="pull-right mleft5 mright25"><small><?php echo _l('disable_all'); ?></small></a>
            <a href="<?php echo admin_url('emails/enable_by_type/si_lead_followup'); ?>" class="pull-right"><small><?php echo _l('enable_all'); ?></small></a>
        <?php } ?>
    ...
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            <tbody>
                <?php foreach ($si_lead_followup_templates as $template) { ?>
                    <tr>
