					...
					<div class="panel-body">
						...
						<div class="si-lead-followup-add-schedule hide">
							...
							<div class="row" id="si_lead_followup_send_wrapper" data-wait-text="<?php echo '<i class=\'fa fa-spinner fa-pulse\'></i> '._l('wait_text'); ?>" data-original-text="<?php echo _l('save'); ?>">
								...
								<div class="col-md-4 border-right">
									<?php echo render_input('schedule_days','si_lfs_schedule_days',1,'number',array('data-toggle'=>'tooltip','data-title'=>_l('si_lfs_schedule_days_info'),'min'=>1,'max'=>100)); ?>
								</div>
								<div class="col-md-4 border-right">
								...
								<div class="col-md-12">
									...
									<?php echo render_textarea('sms_content','si_lfs_text','',array('rows'=>6));?>
									<?php if($merge_fields != ''){?>
								...
								<div class="col-md-12">
									...
									<?php echo render_textarea('email_template_custom', 'email_template', $template->message, [], [], '', 'tinymce-si')?>
								</div>	
								<div class="col-md-12 text-center">
									<p class="text-left text-danger"><?php echo "Note: "._l('si_lfs_schedule_days_info_note')?></p>
									<hr class="hr-10" />
...
<script>
	...
	var select_sms_or_email = '<?php echo _l('si_lfs_select_atleast_one')?>';
</script>	
