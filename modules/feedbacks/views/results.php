    ...
    foreach ($feedback->questions as $question) {  ?>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-right">
                                            <?php
                                                $total_box_description_answers = total_rows(db_prefix() . 'form_results', ['rel_id' => $feedback->feedbackid, 'boxdescriptionid' => $box_description['questionboxdescriptionid'], 'rel_type' => 'feedback']);
                                                $total_box_answers             = total_rows(db_prefix() . 'form_results', ['rel_id' => $feedback->feedbackid, 'boxid' => $box_description['boxid'], 'rel_type' => 'feedback']);
                                                ?>
            ...
            <div class="col-md-6">
                <div class="panel_s">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <?php echo _l('feedback_text_questions_results'); ?>
                        </h4>
                    </div>
                    <div class="panel-body">
                        <?php
                        ...
                        <a href="#questionid_<?php echo $question['questionid']; ?>"
                            data-toggle="modal"><?php echo _l('feedback_view_all_answers'); ?></a>
                        <?php
                            $answers = feedbacks_get_text_question_answers($question['questionid'], $question['rel_id']);
                            ?>
