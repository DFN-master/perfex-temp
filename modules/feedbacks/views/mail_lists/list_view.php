...
<div class="modal fade" id="add_email_to_list" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open('admin/feedbacks/add_email_to_list', ['id' => 'add_single_email_form']); ?>
...
<div class="modal fade" id="import_emails" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('admin/feedbacks/import_emails', ['id' => 'import_emails_form']); ?>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
...
function remove_email_from_mail_list(row, emailid) {
    $.get(admin_url + 'feedbacks/remove_email_from_mail_list/' + emailid, function(response) {
        if (response.success == true) {
            alert_float('success', response.message);
