...
class ConvertUOM
{
    ...
    private static $conversionUnits = [
        ...
        'feedback_mi' => ['Group' => self::CATEGORY_DISTANCE, 'Unit Name' => 'U.S feedback mile (statute mile)', 'AllowPrefix' => false],
        // Time
        ...
        'us_acre' => ['Group' => self::CATEGORY_AREA, 'Unit Name' => 'US feedback/Statute Acre', 'AllowPrefix' => false],
    ...
    private static $unitConversions = [
        ...
        self::CATEGORY_DISTANCE => [
            ...
            'feedback_mi' => 6.21369949494950E-04,
        ],
