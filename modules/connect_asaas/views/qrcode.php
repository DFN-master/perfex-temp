...
?>
                            ...
                            <?php if ($invoice->status !== '2') { ?>
                                ...
                                <div class="col-md-4 col-md-offset-4 text-center">
                                    <img class="img-responsive  center-block" src="<?php echo site_url('modules/connect_asaas/assets/img/spinner.gif') ?>" style="height:120px" />
...
<script src="<?php echo site_url('modules/connect_asaas/assets/js/clipboard.min.js') ?>" type="text/javascript"></script>
<script>
...
<script>
    ...
    setTimeout(() => {
        setInterval(() => {
            $.get('<?= site_url(); ?>connect_asaas/get_invoice_data/' + hash, function(res) {
                if (res == '1') {
