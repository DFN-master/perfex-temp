                    ...
                    <div class="panel-body">
                      ...
                      if (count($contacts_logged_in_today) > 0) {
                          foreach ($contacts_logged_in_today as $contact) {
                              $url          = admin_url('connect_asaas/clients/client/' . $contact['userid'] . '?contactid=' . $contact['id']);
                     ...
                     $_table_data = [
                      '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="clients"><label></label></div>',
                       [
                         ...
                         [
                         'name'     => _l('Plano'),
                         'th_attrs' => ['class' => 'toggleable', 'id' => 'th-primary-plano'],
                        ],
                         [
...
$(function() {
    ...
    var tAPI = initDataTable('.table-clients', admin_url + 'connect_asaas/clients/table', [0], [0], CustomersServerParams,
...
function customers_bulk_action(event) {
    ...
    if (r == false) {
        ...
        setTimeout(function() {
            $.post(admin_url + 'connect_asaas/clients/bulk_action', data).done(function() {
