...
<div class="row">
    <?php echo form_open($this->uri->uri_string(), ['class' => 'client-form', 'autocomplete' => 'off', 'id'=>"form-clients"]); ?>
    <input name="my_action" id="asaas_action" type="hidden" />
...
if($client->asaas_customer_id){
                  echo "<a href='https://www.asaas.com/customerAccount/show/{$client->asaas_customer_id}' title='Clique para abrir no Asaas' target='_blank'>Abrir Cadastro no Asaas</a>  <br/><br/>";
}
}
?>
                <div class="row">
                    ...
                    <div class="col-md-<?php echo !isset($client) ? 12 : 12; ?>"> <!-- Antes: 8, é aqui que muda a dimensão -->
                      ...
                      echo render_input('vat', 'client_vat_number', $value, 'text', ['required'=>true]);
                  } ?>
                    ...
                    //   echo render_input('website', 'client_website', $value);
                     ...
                     $groups = array_merge([['id' => '', 'name' => _l('dropdown_non_selected_tex')]], $groups);
                     if (is_admin() || get_option('staff_members_create_inline_customer_groups') == '1') {
                         echo render_select_with_input_group('groups_in[]', $groups, ['id', 'name'], 'customer_groups', $selected, '<div class="input-group-btn"><a href="#" class="btn btn-default" data-toggle="modal" data-target="#customer_group_modal"><i class="fa fa-plus"></i></a></div>', ['required'=>true,'data-actions-box' => true,'id'=>'groups_in'], [], '', '', false);
                     } else {
                         echo render_select('groups_in[]', $groups, ['id', 'name'], 'customer_groups', $selected, ['required'=>true,'data-actions-box' => true,'id'=>'groups_in'], [], '', '', false);
                     }
                     ?>
                     ...
                     ?>
                        ...
                        <?php echo render_input('zip', 'client_postal_code', $value, null, ['required'=>true]); ?>
                        <?php $value = (isset($client) ? $client->address : ''); ?>
                        <?php echo render_textarea('address', 'client_address', $value, ['required'=>true]); ?>
                        <?php $value = (isset($client) ? $client->city : ''); ?>
                        <?php echo render_input('city', 'client_city', $value,null, ['required'=>true, 'readonly'=>true]); ?>
                        <?php $value = (isset($client) ? $client->state : ''); ?>
                        <?php echo render_input('state', 'client_state', $value,null, ['required'=>true, 'readonly'=>true]); ?>
                        <?php $countries       = get_all_countries();
                     $customer_default_country = get_option('customer_default_country');
                     $selected                 = (isset($client) ? $client->country : $customer_default_country);
                     echo render_select('country', $countries, [ 'country_id', [ 'short_name']], 'clients_country', $selected, ['data-none-selected-text' => _l('dropdown_non_selected_tex'), 'required'=>true, 'data-disabled'=>true]);
                     ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           echo get_staff_full_name($c_admin['staff_id']); ?></a>
                            ...
                            <?php if (has_permission('customers', '', 'create') || has_permission('customers', '', 'edit')) { ?>
                            <td>
                                <a href="<?php echo admin_url('connect_asaas/clients/delete_customer_admin/' . $client->userid . '/' . $c_admin['staff_id']); ?>"
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <?php echo render_input('billing_city', 'billing_city', $value, null, ['readonly'=>true]); ?>
                                <?php $value = (isset($client) ? $client->billing_state : ''); ?>
                                <?php echo render_input('billing_state', 'billing_state', $value, null, ['readonly'=>true]); ?>
                                <?php $value = (isset($client) ? $client->billing_zip : ''); ?>
                                <?php echo render_input('billing_zip', 'billing_zip', $value, null, ['readonly'=>true]); ?>
                                <?php $selected = (isset($client) ? $client->billing_country : ''); ?>
                                <?php echo render_select('billing_country', $countries, [ 'country_id', [ 'short_name']], 'billing_country', $selected, ['data-none-selected-text' => _l('dropdown_non_selected_tex'), 'readonly'=>true]); ?>
                            </div>
                            <div class="col-md-6">
                                <h4
                                    class="tw-font-medium tw-text-base tw-text-neutral-700 tw-flex tw-justify-between tw-items-center tw-mt-0 tw-mb-6">
                                ...
                                <?php echo render_input('shipping_city', 'shipping_city', $value, null, ['readonly'=>true]); ?>
                                <?php $value = (isset($client) ? $client->shipping_state : ''); ?>
                                <?php echo render_input('shipping_state', 'shipping_state', $value, null, ['readonly'=>true]); ?>
                                <?php $value = (isset($client) ? $client->shipping_zip : ''); ?>
                                <?php echo render_input('shipping_zip', 'shipping_zip', $value,null,  ['readonly'=>true]); ?>
                                <?php $selected = (isset($client) ? $client->shipping_country : ''); ?>
                                <?php echo render_select('shipping_country', $countries, [ 'country_id', [ 'short_name']], 'shipping_country', $selected, ['data-none-selected-text' => _l('dropdown_non_selected_tex'), 'readonly'=>true]); ?>
                            </div>
                            <?php if (isset($client) &&
...
<div class="modal fade" id="customer_admins_assign" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('connect_asaas/clients/assign_admins/' . $client->userid)); ?>
...
<?php } ?>
<?php } ?>
<?php $this->load->view('connect_asaas/admin/clients/client_group'); ?>
