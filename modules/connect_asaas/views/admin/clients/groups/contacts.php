...
<div class="inline-block new-contact-wrapper" data-title="<?php echo _l('customer_contact_person_only_one_allowed'); ?>"
    ...
    <a href="#" onclick="saudevivamais_contact(<?php echo $client->userid; ?>); return false;" class="btn btn-primary new-contact mbot15<?php if ($disable_new_contacts) {
        echo ' disabled';
    } ?>">
...
<?php
  ...
  $table_data     = array_merge($table_data, [ _l('contact_position'), _l('client_phonenumber')]);
