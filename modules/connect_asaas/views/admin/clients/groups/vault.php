...
<div
    ...
    <div class="tw-flex tw-justify-between tw-items-center tw-px-6 tw-py-3 tw-border-b tw-border-solid tw-border-neutral-200 tw-bg-neutral-50"
        ...
        <div class="tw-flex-inline tw-items-center tw-space-x-2">
            ...
            <a href="<?php echo admin_url('connect_asaas/clients/vault_entry_delete/' . $entry['id']); ?>"
...
<div class="modal fade" id="entryModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <?php echo form_open(admin_url('connect_asaas/clients/vault_entry_create/' . $client->userid), ['data-create-url' => admin_url('connect_asaas/clients/vault_entry_create/' . $client->userid), 'data-update-url' => admin_url('connect_asaas/clients/vault_entry_update')]); ?>
