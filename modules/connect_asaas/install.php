...
$customfields = [
    ...
    [
        'fieldto'   => 'company',
        'name'      => 'Email Financeiro',
        'slug'      => 'company_email_financeiro',
        'type'      => 'input',
        'active'    => 1,
        'bs_column' => 12
    ]
...
update_option('asaas_campo_personalisado_email_padrao', 'customers_email_do_cliente');
update_option('asaas_campo_personalisado_numero_endereco_padrao', 'customers_numero_do_endere_o');
