        ...
        if (!$customer) {
            ...
            if (isset($response['data'])) {
                ...
                if (!$data) {
                    ...
                    $email_client = $this->asaas_gateway->get_customer_customfields($client->userid, 'customers', 'customers_email_do_cliente');
                    ...
                    $address_number = $this->asaas_gateway->get_customer_customfields($client->userid, 'customers', 'customers_numero_do_endere_o');
