						...
						<div class="hiraheadsummary">
							<div class="hiraheadtop row">
								<div class="col-md-6 border-right">
									...
									<h4><?php echo loy_html_entity_decode($mbs_program->program_name); ?></h4>
									<p><?php echo loy_html_entity_decode($mbs_program->note) ?></p>
								...
								<div class="col-md-6">
									<div class="row">
										...
										<?php 
											...
											echo loy_html_entity_decode($list_rank);
										 ?>
										</p>
										</div>
									...
									<div class="row">
										<div class="col-md-6">
											...
											<p><?php echo loy_html_entity_decode($mbs_program->loyalty_point_from); ?></p>
										</div>

										<div class="col-md-6">
											<p class="assessid"><?php echo _l('point_to'); ?></p>
											<p><?php echo loy_html_entity_decode($mbs_program->loyalty_point_to); ?></p>
										</div>
									</div>
							...
							<div class="hiraclassification">
								...
								<div class="classify_hira col-md-9">
									...
									<?php if($mbs_program->discount_detail != ''){
										...
										<span class="pull-right"><?php echo loy_html_entity_decode($detail['percent']).'%' ?></span></p>
									<?php }
									} ?>

									<?php if($mbs_program->discount == 'card_total'){ ?>
										<p class="classify_value"><?php echo _l('discount_percent').': '.loy_html_entity_decode($mbs_program->discount_percent).'%'; ?>
									<?php } ?>
								</div>
							</div>
						</div>
							...
							<div class="hiraheadsummary">
								<div class="hiraheadtop row">
									<div class="col-md-12">
										...
										<h4><?php echo _l('voucher_code').': '; ?><span class="text-danger"><?php echo loy_html_entity_decode($mbs_program->voucher_code); ?></span></h4>
										<p><?php echo _l('voucher_value').': '; ?><span class="text-info"><?php echo loy_html_entity_decode($mbs_program->voucher_value); ?></span></p>
