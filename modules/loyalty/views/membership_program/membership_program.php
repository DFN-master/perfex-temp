		...
		<div class="row">
			<div class="panel_s mbot10">
				<div class="panel-body">
					<div class="col-md-12">
						<h4><?php echo loy_html_entity_decode($title); ?></h4>
					</div>
											...
											foreach($mbs_program->discount_detail as $rule_dt){ ?>
												<div id ="new_kpi" class="row padbot5" >
													<div class="col-md-7 padright0">
														<select name="product_category[<?php echo loy_html_entity_decode($count); ?>]" class="selectpicker" data-live-search="true" id="product_category[<?php echo loy_html_entity_decode($count); ?>]" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" > 
															<option value=""></option>
													...
													<div class="col-md-4 padright0">
														...
														<input type="number" id="percent_cate[<?php echo loy_html_entity_decode($count); ?>]" name="percent_cate[<?php echo loy_html_entity_decode($count); ?>]" class="form-control" value="<?php echo loy_html_entity_decode($rule_dt['percent']) ?>" aria-invalid="false" >
													</div>
									...
									<div class="col-md-12 new-product-rule">
										...
										<?php if(isset($mbs_program)) { ?>
											<?php if($mbs_program->discount == 'product' && count($mbs_program->discount_detail) > 0) { ?>
												...
												foreach($mbs_program->discount_detail as $rule_pd){ ?>	
													...
													<div id ="new_rule" class="row padbot5">
														<div class="col-md-7 padright0" >
															<select name="product[<?php echo loy_html_entity_decode($count1); ?>]" class="selectpicker" data-live-search="true" id="product[<?php echo loy_html_entity_decode($count1); ?>]" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" > 
																<option value=""></option>
														...
														<div class="col-md-4 padright0" >
															...
															<input type="number" id="percent_product[<?php echo loy_html_entity_decode($count1); ?>]" name="percent_product[<?php echo loy_html_entity_decode($count1); ?>]" class="form-control" value="<?php echo loy_html_entity_decode($rule_pd['percent']); ?>" aria-invalid="false" >
														</div>
														<div class="col-md-1" name="button_add_kpi addbtn_style" >
											...
											<div class="col-md-12 form-group">
												...
												<select name="membership[]" id="membership" class="selectpicker" data-live-search="true" required="true" multiple="" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" >
													<?php foreach($memberships as $mem){ ?>
														<option value="<?php echo loy_html_entity_decode($mem['id']); ?>" <?php if(isset($mbs_program) && in_array($mem['id'], $membership)){ echo 'selected'; } ?> ><?php echo loy_html_entity_decode($mem['name']); ?></option>
													<?php } ?>
												</select>
												<br>
											</div>
										...
										<div role="tabpanel" class="tab-pane" id="voucher_infor">
											...
											<div class="col-md-6">
												...
												<div class="input-group" id="discount-total">
													<input type="text" class="form-control text-right" data-type="currency" name="minium_purchase" value="<?php echo loy_html_entity_decode($minium_purchase); ?>">
