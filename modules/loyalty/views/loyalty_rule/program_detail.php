						...
						<div class="hiraheadsummary">
							<div class="hiraheadtop row">
								<div class="col-md-6 border-right">
									...
									<h4><?php echo loy_html_entity_decode($loyalty_program->subject); ?></h4>
									<p><?php echo loy_html_entity_decode($loyalty_program->note) ?></p>
								...
								<div class="col-md-6">
									<div class="row">
										...
										<p>
										<?php echo loy_html_entity_decode($loyalty_program->min_poin_to_redeem); ?>
										</p>
										</div>
							...
							<div class="hiraclassification">
								...
								<div class="classify_hira col-md-9">
									...
									<?php if($loyalty_program->rule_detail != ''){
										...
										<span class="pull-right"><?php echo _l('poin_awarded').': '.loy_html_entity_decode($detail['loyalty_point']); ?></span></p>
									<?php }
									} ?>

									<?php if($loyalty_program->rule_base == 'card_total'){ ?>
										<p class="classify_value"><?php echo _l('poin_awarded').': '; ?> <span class="text-info"><?php echo loy_html_entity_decode($loyalty_program->poin_awarded); ?></span><?php echo ' '._l('purchase_value_text_label').': '; ?><span class="text-info"><?php echo loy_html_entity_decode($loyalty_program->purchase_value).' '.$base_currency->name; ?></span><p>
									<?php } ?>
								</div>
							</div>
						</div>
