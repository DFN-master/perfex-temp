							...
							<div class="row">
									...
									<div class="col-md-6 form-group">
								        ...
								        <select name="client_group" id="client_group" onchange="client_group_change(this); return false;" class="selectpicker"  data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" >
								            ...
								            <?php foreach($client_groups as $gr){ ?>
								             <option value="<?php echo loy_html_entity_decode($gr['id']); ?>" <?php if(isset($loyalty_rule) && $loyalty_rule->client_group == $gr['id']){ echo 'selected'; } ?> ><?php echo loy_html_entity_decode($gr['name']); ?></option>
								           <?php } ?>
								        </select>
								    </div> 
								    ...
								    <div class="col-md-6 form-group">
								        ...
								        <select name="client[]" id="client" class="selectpicker" multiple="true"  data-live-search="true" data-actions-box="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" >
								          <?php foreach($clients as $cli){ ?>
								           <option value="<?php echo loy_html_entity_decode($cli['userid']); ?>" <?php if(isset($loyalty_rule) && in_array($cli['userid'], $clients_ed)){ echo 'selected'; } ?> ><?php echo loy_html_entity_decode($cli['company']); ?></option>
								         <?php } ?>
								       </select>
								    </div>
								...
								<div role="tabpanel" class="tab-pane" id="poin_calculation">
									...
									<div class="col-md-12 mtop5">
										<p class="bold p_style"><?php echo _l('loy_when_paying_invoice'); ?></p>
        								<hr class="hr_style"/>
									</div>
									...
									<div class="col-md-6">
										...
										<div class="input-group" id="discount-total">
											<input type="text" class="form-control text-right" data-type="currency" required name="minium_purchase" value="<?php echo loy_html_entity_decode($minium_purchase); ?>">
											<div class="input-group-addon">
												<div class="dropdown">
													<span class="discount-type-selected">
														<?php echo loy_html_entity_decode($base_currency->name) ;?>
													</span>
												</div>
											</div>
										</div>
													...
													foreach($loyalty_rule->rule_detail as $key => $rule_dt){ ?>
														<div id ="new_kpi" class="row padbot5" >
															<div class="col-md-7 padright0">
																<select name="product_category[<?php echo loy_html_entity_decode($key); ?>]" class="selectpicker" data-live-search="true" id="product_category[<?php echo loy_html_entity_decode($key); ?>]" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" > 
																	<option value=""></option>
																	<?php foreach ($item_groups as $jp){ ?>
																		<option value="<?php echo loy_html_entity_decode($jp['id']); ?>" <?php if($jp['id'] == $rule_dt['rel_id']){ echo 'selected';} ?>><?php echo loy_html_entity_decode($jp['name']); ?></option>
																	<?php } ?>
																</select>
															</div>
															...
															<div class="col-md-4 padright0">
																...
																<input type="number" id="point[<?php echo loy_html_entity_decode($key); ?>]" name="point[<?php echo loy_html_entity_decode($key); ?>]" class="form-control" value="<?php echo loy_html_entity_decode($rule_dt['loyalty_point']) ?>" aria-invalid="false" >
															</div>
														...
														<div id ="new_kpi" class="row padbot5">
															<div class="col-md-7 padright0">
																<select name="product_category[0]" class="selectpicker" data-live-search="true" id="product_category[0]" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" > 
																	<option value=""></option>
																	<?php foreach ($item_groups as $jp){ ?>
																		<option value="<?php echo loy_html_entity_decode($jp['id']); ?>"><?php echo loy_html_entity_decode($jp['name']); ?></option>
																	<?php } ?>
																</select>
															</div>
										...
										<div id="product_rule_div" class="hide">
											<div class="col-md-12 new-product-rule">
													...
													<?php if($loyalty_rule->rule_base == 'product' && count($loyalty_rule->rule_detail) > 0) { ?>
														...
														foreach($loyalty_rule->rule_detail as $key1 => $rule_pd){ ?>	
															...
															<div id ="new_rule" class="row padbot5">
																<div class="col-md-7 padright0" >
																	<select name="product[<?php echo loy_html_entity_decode($key1); ?>]" class="selectpicker" data-live-search="true" id="product[<?php echo loy_html_entity_decode($key1); ?>]" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" > 
																		<option value=""></option>
																		<?php foreach ($items as $jp){ ?>
																			<option value="<?php echo loy_html_entity_decode($jp['itemid']); ?>" <?php if($jp['itemid'] == $rule_pd['rel_id']){ echo 'selected';} ?> ><?php echo loy_html_entity_decode($jp['description']); ?></option>
																		<?php } ?>
																	</select>
																</div>
																...
																<div class="col-md-4 padright0" >
																	...
																	<input type="number" id="point_product[<?php echo loy_html_entity_decode($key1); ?>]" name="point_product[<?php echo loy_html_entity_decode($key1); ?>]" class="form-control" value="<?php echo loy_html_entity_decode($rule_pd['loyalty_point']); ?>" aria-invalid="false" >
																</div>
																<div class="col-md-1" name="button_add_kpi addbtn_style" >
															...
															<div id ="new_rule" class="row padbot5" >
																<div class="col-md-7 padright0">
																	<select name="product[0]" class="selectpicker" data-live-search="true" id="product[0]" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" > 
																		<option value=""></option>
																		<?php foreach ($items as $jp){ ?>
																			<option value="<?php echo loy_html_entity_decode($jp['itemid']); ?>"><?php echo loy_html_entity_decode($jp['description']); ?></option>
																		<?php } ?>
																	</select>
																</div>
												...
												<div id="card_total_rule_div">
													...
													<div class="col-md-6">
														...
														<div class="input-group" id="discount-total">
															<input type="text" class="form-control text-right" data-type="currency" name="purchase_value" value="<?php echo loy_html_entity_decode($purchase_value); ?>">
															<div class="input-group-addon">
																<div class="dropdown">
																	<span class="discount-type-selected">
																		<?php echo loy_html_entity_decode($base_currency->name) ;?>
												...
												<div class="col-md-12 mtop10">
													<p class="bold p_style"><?php echo _l('loy_other_actions'); ?></p>
			        								<hr class="hr_style"/>
												</div>

												<div class="col-md-6">
													<label for="create_account_point"><?php echo _l('create_account_point').' '; ?><i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="<?php echo _l('create_account_point_note'); ?>"></i></label>
													<?php $create_account_point = (isset($loyalty_rule) ? $loyalty_rule->create_account_point : '');
													echo render_input('create_account_point', '', $create_account_point, 'number'); ?>
												</div>

												<div class="col-md-6">
													<label for="birthday_point"><?php echo _l('birthday_point').' '; ?><i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="<?php echo _l('birthday_point_note'); ?>"></i></label>
													<?php $birthday_point = (isset($loyalty_rule) ? $loyalty_rule->birthday_point : '');
													echo render_input('birthday_point', '', $birthday_point, 'number'); ?>
												</div>
											...
											<div role="tabpanel" class="tab-pane" id="redeemp_calculation">
												...
												<div class="col-md-2">
													...
													<div class="input-group" id="discount-total">
														<input type="number" class="form-control text-right" required name="max_amount_received" min="0" max="100" value="<?php echo loy_html_entity_decode($max_amount_received); ?>">
														<div class="input-group-addon">
															<div class="dropdown">
																<span class="discount-type-selected">
																	<?php echo '%';?>
													...
													foreach($loyalty_rule->redemp_detail as $key2 => $rd){ ?>
														<div id ="new_redemp" class="row padbot5">
															<div class="col-md-3 padleft0 padright0">
																<input type="text" id="rule_name[<?php echo loy_html_entity_decode($key2); ?>]" name="rule_name[<?php echo loy_html_entity_decode($key2); ?>]" class="form-control" value="<?php echo loy_html_entity_decode($rd['rule_name']); ?>" aria-invalid="false" >
															</div>

															<div class="col-md-2 padright0">
																<input type="number" id="point_from[<?php echo loy_html_entity_decode($key2); ?>]" name="point_from[<?php echo loy_html_entity_decode($key2); ?>]" class="form-control" value="<?php echo loy_html_entity_decode($rd['point_from']); ?>" aria-invalid="false" >
															</div>

															<div class="col-md-2 padright0" >
																<input type="number" id="point_to[<?php echo loy_html_entity_decode($key2); ?>]" name="point_to[<?php echo loy_html_entity_decode($key2); ?>]" class="form-control" value="<?php echo loy_html_entity_decode($rd['point_to']); ?>" aria-invalid="false" >
															</div>

															<div class="col-md-2 padright0">
																<input type="number" id="point_weight[<?php echo loy_html_entity_decode($key2); ?>]" name="point_weight[<?php echo loy_html_entity_decode($key2); ?>]" class="form-control" value="<?php echo loy_html_entity_decode($rd['point_weight']); ?>" step="0.01" >
															</div>

															<div class="col-md-2 padright0">
																<select name="status[<?php echo loy_html_entity_decode($key2); ?>]" class="selectpicker" data-live-search="true" id="status[<?php echo loy_html_entity_decode($key2); ?>]" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" > 
																	<option value=""></option>
