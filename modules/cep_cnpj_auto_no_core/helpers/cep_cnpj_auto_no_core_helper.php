...
if (!function_exists('formatResponse')) {
     ...
     */
    function formatResponse($data, $message, $verb = "insert",
            $type = 'success') {
        header('Content-Type: application/json');

        $arr = ['type' => $type, 'data' => $data, 'verb' => $verb,
...
if (!function_exists('fazer_upload')) {
    ...
    /**
     *
     * @param string $mediaPath O caminho para salvar os arquivos
     * @param string $input_name O nome do input do cliente
     * @param string $column_table O nome da coluna no banco de dados
     * @return void
     */
