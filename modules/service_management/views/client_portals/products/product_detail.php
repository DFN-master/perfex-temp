		...
		<div class="details col-md-6">
			...
			<div class="action row">
				...
				<div class="col-md-12">
					...
					<?php if($detailt_product->service_type == 'normal'){ ?>
						<button type="button" class="add_cart btn btn-success mleft10" data-id=""><i class="fa fa-shopping-cart"></i><?php echo _l('sm_add_to_cart'); ?></button>
					<?php }else if($detailt_product->service_type == 'subscriptions'){ ?>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12 alert_content">
							...
							<br>
							<br>
							<center class="add_success hide"><h4><?php echo _l('sm_added_successfully'); ?></h4></center>
