...
<div class="panel_s section-heading section-invoices">
	<div class="panel-body">
		...
		<div class="col-md-3 left_bar">
			<ul class="nav-tabs--vertical nav" role="navigation">
				<li class="head text-center">
					...
					<a href="<?php echo site_url('service_management/service_management_client/products_service_managements/1/0/0'); ?>" class="view_all"><?php echo _l('sm_all_products'); ?></a> 
				</li>
				<?php 
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="pb-1 add-cart">
											...
											<button type="button" class="add_cart btn btn-success" data-id=""><i class="fa fa-shopping-cart"></i><?php echo _l('sm_add_to_cart'); ?></button>
										</div>
									</div>
								</div>
							</div>
		...
		<input type="hidden" name="msg_add" value="<?php echo _l('sm_added_successfully'); ?>">
