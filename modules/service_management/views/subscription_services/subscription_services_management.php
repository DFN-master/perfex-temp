...
<div id="wrapper">
			...
			<div class="col-md-12" id="small-table">
				<div class="panel_s">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<h4 class="no-margin h4-color"><i class="fa fa-repeat menu-icon" aria-hidden="true"></i> <?php echo _l($title); ?></h4>
							</div>
						</div>
						<hr class="hr-color">
						...
						<div class="row ">
							<div class="col-md-4 ">
								<?php if (has_permission('service_management', '', 'create') || has_permission('service_management', '', 'edit') ) { ?>
									...
									<a href="<?php echo admin_url('service_management/add_edit_subscription'); ?>" class="btn btn-info pull-left display-block mright5"><?php echo _l('sm_add'); ?></a>
						...
						<div class="row">
							...
							<div class=" col-md-4 ">
								<div class="form-group">
									<select name="item_filter[]" id="item_filter" class="selectpicker" multiple="true" data-actions-box="true" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('sm_subscription_label'); ?>">

										<?php foreach($products_services as $service) { ?>
											<option value="<?php echo new_html_entity_decode($service['id']); ?>"><?php echo new_html_entity_decode($service['description']); ?></option>
										<?php } ?>
									</select>
								</div>
							</div>
							...
							<div class=" col-md-4 ">
								<div class="form-group">
									<select name="product_category_filter[]" id="product_category_filter" class="selectpicker" multiple="true" data-actions-box="true" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('sm_group'); ?>">
	...
	<?php init_tail(); ?>
<?php require 'modules/service_management/assets/js/subscription_services/subscription_services_management_js.php'; ?>
</body>
</html>
