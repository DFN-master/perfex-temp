...
function sm_check_image_items($item_id, $file_name){
	...
	$check_img = false;
	if(sm_get_status_modules('warehouse') == true){
	...
	if(!$check_img && sm_get_status_modules('purchase') == true){
	...
	if(!$check_img && sm_get_status_modules('manufacturing') == true){
	...
	if(!$check_img && sm_get_status_modules('service_management') == true){
...
function sm_get_status_modules($module_name){
	$CI             = &get_instance();
