<script>
	$(function(){
		...
		var _table_api = initDataTable(product_table, admin_url+'service_management/subscription_services_table', [0], [0], ProposalServerParams,  [1, 'desc']);
	...
	function warehouse_delete_bulk_action(event) {
		...
		if (confirm_delete()) {
			...
			if(mass_delete == true){
				...
				setTimeout(function() {
					$.post(admin_url + 'service_management/sm_product_delete_bulk_action', data).done(function() {
