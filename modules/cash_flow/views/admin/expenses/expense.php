                ...
                <div class="">
                    ...
                    <div class="panel_s">
                        <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <i class="<?php echo get_mime_class($expense->filetype); ?>"></i> <a
                                            href="<?php echo site_url('cash_flow/file/expense/' . $expense->expenseid); ?>"><?php echo ($expense->attachment); ?></a>
                                    </div>
                                    <?php if ($expense->attachment_added_from == get_staff_user_id() || is_admin()) { ?>
                                        <div class="col-md-2 text-right">
                                            <a href="<?php echo admin_url('cash_flow/delete_expense_attachment/' . $expense->buisness_id . '/' . $expense->expenseid); ?>"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <?php hooks()->do_action('before_cashflow_form_name', isset($expense) ? $expense : null); ?>
                                </div>
                                <div class="col-md-6">
                                    <?php
                            ...
                            <input type="hidden" name="buisness_id" value="<?php echo $buisness_id ?>">
                            ...
                            <?php $value = (isset($expense) ? $expense->paid_to : ''); ?>
                            <?php echo render_input('paid_to', 'expense_paid_to', $value, ''); ?>
                            ...
                            ?>
                            <div class="form-group projects-wrapper hide<?php echo ($hide_project_selector); ?>">
                            ...
                            <div class="btn-bottom-toolbar text-right">
                                <button type="submit" class="btn btn-primary"><?php echo _l('cf_submit'); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            if (response.expenseid) {
                if (typeof(expenseDropzone) !== 'undefined') {
                    if (expenseDropzone.getQueuedFiles().length > 0) {
                        expenseDropzone.options.url = admin_url + 'cash_flow/add_expense_attachment/' + response
                            .expenseid + '/' + buisness_id;
