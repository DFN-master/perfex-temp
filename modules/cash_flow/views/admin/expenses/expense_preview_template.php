                    ...
                    <div class="pull-right">
                        <?php if (staff_can('edit', 'cash_flow')) { ?>
                            <a class="btn btn-default btn-with-tooltip"
                                href="<?php echo admin_url('cash_flow/expense/' . $expense->buisness_id . '/' . $expense->expenseid); ?>"
                        ...
                        <?php if (staff_can('create', 'cash_flow')) { ?>
                            <a class="btn btn-default btn-with-tooltip"
                                href="<?php echo admin_url('cash_flow/copy/' . $expense->buisness_id . '/' . $expense->expenseid); ?>"
                        ...
                        <?php if (staff_can('delete', 'cash_flow')) { ?>
                            <a class="btn btn-danger btn-with-tooltip _delete"
                                href="<?php echo admin_url('cash_flow/delete/' . $expense->buisness_id . '/' . $expense->expenseid); ?>"
                ...
                <div role="tabpanel" class="tab-pane ptop10 active" id="tab_expense"
                    ...
                    <div class="col-md-6">
                        ...
                        <div id="amountWrapper">
                            ...
                            <span class="text-danger bold font-medium">
                                <?php echo (app_format_money($expense->amount, $expense->currency_data)); ?>
                            </span>
                        </div>
                        ...
                        <?php
                        if ($expense->tax != 0) {
                            echo '<br /><span class="bold">' . _l('tax_1') . ':</span> ' . e($expense->taxrate) . '% (' . ($expense->tax_name) . ')';
                            $total = $expense->amount;
                            $total += ($total / 100 * $expense->taxrate);
                        }
                        if ($expense->tax2 != 0) {
                            echo '<br /><span class="bold">' . _l('tax_2') . ':</span> ' . e($expense->taxrate2) . '% (' . ($expense->tax_name2) . ')';
                        ...
                        <?php if ($expense->clientid) { ?>
                            ...
                            <p class="mbot15">
                                <a href="<?php echo admin_url('clients/client/' . $expense->clientid); ?>">
                                    <?php echo ($expense->company); ?>
                                </a>
                            </p>
                        <?php } ?>
                        <?php if ($expense->project_id) { ?>
                            ...
                            <p class="mbot15">
                                <a href="<?php echo admin_url('projects/view/' . $expense->project_id); ?>">
                                    <?php echo ($expense->project_data->name); ?>
                                </a>
                            </p>
                        <?php } ?>
                        <?php
                    ...
                    <div class="col-md-6" id="expenseReceipt">
                        ...
                        <?php if (empty($expense->attachment)) { ?>
                            <?php echo form_open('cash_flow/add_expense_attachment/' . $expense->expenseid . '/' . $expense->buisness_id, ['class' => 'mtop10 dropzone dropzone-expense-preview dropzone-manual', 'id' => 'expense-receipt-upload']); ?>
                        ...
                        <?php } else { ?>
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <a href="<?php echo site_url('download/file/expenses/' . $expense->expenseid); ?>">
                                ...
                                <?php if ($expense->attachment_added_from == get_staff_user_id() || is_admin()) { ?>
                                    <div class="col-md-2 text-right">
                                        <a class="_delete text-danger"
                                            href="<?php echo admin_url('cash_flow/delete_expense_attachment/' . $expense->buisness_id . '/' . $expense->expenseid . '/' . 'preview'); ?>"
                                            class="text-danger">
                                ...
                                <li class="list-group-item">
                                    ...
                                    <span class="inline-block mtop10">
                                        ...
                                        <p><span class="bold font-medium"><?php echo _l('expense_amount'); ?></span>
                                            <span class="text-danger bold font-medium">
                                                <?php echo (app_format_money($recurring->amount, $recurring->currency_data)); ?>
                                            </span>
                                            <?php
                                            if ($recurring->tax != 0) {
