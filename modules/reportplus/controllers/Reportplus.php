...
class Reportplus extends AdminController
{
    ...
    public function generate_report()
    {
        ...
        if ($this->input->post()) {
            ...
            $emailTemplate = $this->load->view('email_template', ['generatedReport' => $generatedReport], true);
    ...
    public function view_report($report_id)
    {
        ...
        $data['generated_report'] = $this->load->view('email_template', ['generatedReport' => $toArrayReports], true);
