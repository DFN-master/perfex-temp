...
<div id="wrapper">
	<div class="content">
		<div class="row">
							...
							<div class="panel-body">
								...
								<div class="form-group">
		                            <div class="checkbox checkbox-primary checkbox-inline">
		                                <input type="checkbox" name="receipt_for_a_specific_agent" id="receipt_for_a_specific_agent"
		                                    <?php echo (isset($receipt) && $receipt->receipt_for_a_specific_agent == 1 ? 'checked' : ''); ?>>
		                                <label for="receipt_for_a_specific_agent">
		                                    <?php echo _l('receipt_for_a_specific_agent'); ?>
		                                </label>
		                            </div>
		                        </div>
		                        <div id="div_receipt_for_a_specific_agent" class="<?php echo (isset($receipt) && $receipt->receipt_for_a_specific_agent == 1 ? '' : 'hide'); ?>">
		                        	<?php $value = (isset($receipt) ? $receipt->agent : '') ?>
									<?php echo render_select('agent', $list_agents, array('id','name'), 'agent', $value, array(), array(), '', '', false);
									?>
		                        </div>
			...
			<?php echo form_hidden('receipt_id', $receipt->id); ?>
			<div class="col-md-7">
				<div class="panel_s">
					<div class="panel-body">
