...
<table class="table dt-table border table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="#" onclick="edit_salesadmin_customer_group(this,<?php echo html_entity_decode($value['id']); ?>); return false;" data-customer_group="<?php echo html_entity_decode($value['customer_group']); ?>" data-salesadmin="<?php echo html_entity_decode($value['salesadmin']); ?>" class="btn btn-default btn-icon"><i class="fa fa-pencil-square"></i>
                </a>
