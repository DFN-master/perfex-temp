      ...
      <div class="panel_s">
        <div class="panel-body">
          ...
          <div class="row <?php if(isset($commission_policy) && $commission_policy->commission_policy_type == '3'){ echo '';}else{echo 'is_hide';}?>" id="calculated_by_the_product">
              <div class="form-group col-md-12">
              <h5 class="font-bold"><?php echo _l('calculated_by_the_product'); ?></h5>
                <?php
                  $selected = (isset($commission_policy) ? $commission_policy->percentage_of_product_type : ''); 
                  ?>
                <label for="percentage_of_product_type"><?php echo _l('applicable_type'); ?></label><br />
                <div class="radio radio-inline radio-primary">
                  <input type="radio" name="percentage_of_product_type" id="percentage_of_product_type_number" value="number" <?php if($selected == 'number'|| $selected == ''){echo 'checked';} ?>>
                  <label for="percentage_of_product_type_number"><?php echo _l("quantily"); ?></label>
                </div>
                <div class="radio radio-inline radio-primary">
                  <input type="radio" name="percentage_of_product_type" id="percentage_of_product_type_amount" value="amount" <?php if($selected == 'amount'){echo 'checked';} ?>>
                  <label for="percentage_of_product_type_amount"><?php echo _l("amount"); ?></label>
                </div>
              </div>
            <div class="col-md-12">
