...
<head>
    ...
    <title>
        Pagamento da <?php echo format_invoice_number($id); ?>
    </title>

    <link rel="stylesheet" type="text/css" id="reset-css" href="<?php echo module_dir_url('gerencianet_gateway', 'assets/css/reset.min.css?v=2.8.1'); ?>">

    <link rel="stylesheet" type="text/css" id="reset-css" href="<?php echo module_dir_url('gerencianet_gateway', '/assets/css/bootstrap.min.css?v=2.8.1'); ?>">

    <link rel="stylesheet" type="text/css" id="reset-css" href="<?php echo module_dir_url('gerencianet_gateway', '/assets/css/roboto.css?v=2.8.1'); ?>">

    <link rel="stylesheet" type="text/css" id="reset-css" href="<?php echo module_dir_url('gerencianet_gateway', '/assets/css/bs-overides.min.css?v=2.8.1'); ?>">

    <link rel="stylesheet" type="text/css" id="reset-css" href="<?php echo module_dir_url('gerencianet_gateway', '/assets/css/style.min.css'); ?>">

    <script src="<?php echo module_dir_url('gerencianet_gateway', '/assets/js/jquery.min.js'); ?>"></script>
...
<body class="customers safari viewinvoice">
    ...
    <div id="wrapper">
        <div id="content">
            <div class="container">
                <div class="row">
                    <?php if (!empty($this->session->flashdata('message-warning'))) { ?>
                        <div class="alert alert-danger" id="alert-info" style="
                                   align-content: space-around;
                                   align-items: center;
                                   display:flex;
                                   justify-content: space-between;" role="alert">
                            <div id="alert-get-message"><?php echo $this->session->flashdata('message-warning'); ?></div>
                            <div>
                                <span aria-hidden="true" class="btn" data-dismiss="alert" aria-label="Close">&times;</span>
                            </div>
                        </div>
                    <?php } ?>
                    <div class="alert alert-danger" id="alert-info" style="
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            ?>
                                                                ...
                                                                <div class="col-md-6 justify-content-center">
                                                                    <ul>
                                                                        <li class="sc-bWNSNh ijsSky how-to pixx">
                                                                            <span><strong>1. Abra o app do seu banco e
                                                                                    acesse o ambiente Pix.</strong></span>
                                                                        </li>
                                                                        <li class="sc-bWNSNh ijsSky how-to pixx">
                                                                            <span><strong>2. escolha a opção pagar com qr
                                                                                    code e escaneie o código ao
                                                                                    lado</strong></span>
                                                                        </li>
                                                                        <li class="sc-bWNSNh ijsSky how-to pixx">
                                                                            <span>3. Confirme as informações e finalize o
                                                                                pagamento no seu
                                                                                APP.</span>
                                                                        </li>
                                                                    </ul>
                                                                    ...
                                                                    <div style="margin-top:40px;">
                                                                        <span style="display: block;margin-top:-1px; margin-left: auto; margin-right: auto; padding-top:11px;padding-bottom:10px;" class="label label-danger s-status invoice-status-1">Aguardando
                                                                            pagamento</span>
                                                                        <div style="margin-top:-7px;">
                                                                            <h2 style="float: left !important">Total:</h2>
                                                                            <h2 style="float: right !important">
                                                                                <strong>R$
                                                                                    <?php echo money($total); ?></strong>
                                                                            </h2>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div>
                                                                        ...
                                                                        <div class="col text-center">
                                                                            ...
                                                                            <button style="margin-top: 10px; margin-bottom: 10px;" disabled="" class="btn btn-info btn-copy-qrcode" type="button">
                                                                                Copiar Chave
                                                                            </button>
                                                                        </div>
                                                            ...
                                                            <div class="row d-flex justify-content-center">
                                                                <div class="col-md-12 justify-content-center">
                                                                    <ul>
                                                                        ...
                                                                        <li class="sc-bWNSNh ijsSky how-to pixx">
                                                                            <span><strong>2. Abra o app do seu banco ou
                                                                        ...
                                                                        <li class="sc-bWNSNh ijsSky how-to pixx">
                                                                            <span>3. Cole o código, confira as informações e
                                                                                finalize a
                                                                                compra</span>
                                                                        </li>
                                                                    </ul>
                                                                    ...
                                                                    <div>
                                                                        <span style="display: block; margin-left: auto; margin-right: auto" class="label label-danger s-status invoice-status-1">Aguardando
                                                                            pagamento</span>
                                                                        <div>
                                                                            <h2 style="float: left !important">Total:</h2>
                                                                            <h2 style="float: right !important">
                                                ...
                                                <script>
                                                    function setDataAlertInfo(message) {
                                                        $("#alert-info").css({
                                                            'display': 'flex'
                                                        }).show().find("#alert-get-message").append(`<p>${message}</p>`);
                                                    }
                                                    ...
                                                    window.addEventListener('load', function() {
                                                        ...
                                                        if (pixAtivo) {
                                                            ...
                                                            const urlGeracaoPix = `${baseUrl}gerencianet_gateway/gerencia_net/gerar_pix_por_javascript/${invoice_id}/${hash}`;
                                                            $.ajax({
                                                                url: urlGeracaoPix,
                                                                method: 'POST',
                                                                data: {
...
const obj = response;
                                                                        ...
                                                                        if (obj.error) {
                                                                            setDataAlertInfo(obj.message);
                                                                        } else {
                                                                            $('.btn-copy-qrcode').removeAttr(
                                                                                'disabled');

                                                                            $('.placeholder-item').hide();

                                                                            $('.get-img-qrcode').attr("src", obj
                                                                                .message.imagemQrcode);

                                                                            $('.input-get-qrcode').val(obj.message
                                                                                .qrcode);

                                                                            const txid = obj.message.txid;

                                                                            setTimeout(() => {
                                                                                setInterval(() => {
                                                                                    $.get(`<?php echo base_url() ?>gerencianet_gateway/gerencia_net/callback_check_pix_pago/${txid}/${invoice_id}`,
                                                                                        function(
                                                                                            response
                                                                                        ) {
                                                                                            if (response ==
                                            ...
                                            ?>
                                                    ...
                                                    <div class="modal-dialog modal-confirm">
                                                        <div class="modal-content" style="margin-top:100px;">
                                                            <div class="modal-header">
                                                                <div class="icon-box">
                                                                    <i class="material-icons" style="display: flex; justify-content: center; margin-top: -70px;">

                                                                        <svg width="100px" enable-background="new 0 0 455.431 455.431" version="1.1" viewBox="0 0 455.431 455.431" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
                                                                            <path d="m405.49 412.76c-69.689 56.889-287.29 56.889-355.56 0-69.689-56.889-62.578-300.09 0-364.09s292.98-64 355.56 0 69.689 307.2 0 364.09z" fill="#8DC640" />
                                                                            <g opacity=".2">
                                                                                <path d="m229.14 313.21c-62.578 49.778-132.27 75.378-197.69 76.8-48.356-82.489-38.4-283.02 18.489-341.33 51.2-52.622 211.91-62.578 304.36-29.867 22.755 93.867-24.178 213.33-125.16 294.4z" fill="#fff" />
                                                                            </g>
                                                                            <path d="m195 354.45c-9.956 0-19.911-4.267-25.6-12.8l-79.644-102.4c-11.378-14.222-8.533-34.133 5.689-45.511s34.133-8.533 45.511 5.689l54.044 69.689 119.47-155.02c11.378-14.222 31.289-17.067 45.511-5.689s17.067 31.289 5.689 45.511l-145.07 187.73c-7.111 7.111-15.644 12.8-25.6 12.8z" fill="#fff" />
                                                                        </svg>
                                                                    </i>
                                                                </div>
                                                                <h1 class="bold invoice-html-number" style="text-align: center;"><strong>O pagamento está em
                                                                        processamento.</strong></h1>
                                                            </div>
                                                            <div class="modal-body">
                                                                <p class="text-center">
                                                                    Você pode sair dessa página à vontade, todos os demais
                                                                    passos serão enviados no seu email (<span id="mostrar-email"></span>). Muito obrigado!
                                                                </p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button class="btn btn-success btn-block" data-dismiss="modal">Retornar para a fatura</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="sc-hKizKw ceBZw">
                                                        <div data-cy="bankSlipContent" id="bank-slip" class="sc-gGiJkG jzdkxv">
                                                            ...
                                                            <div>
                                                                        ...
                                                                        <div class="card">
                                                                            <div class="front">
                                                                                ...
                                                                                <span class="card_number">&#x25CF;&#x25CF;&#x25CF;&#x25CF;
                                                                                    ...
                                                                                    &#x25CF;&#x25CF;&#x25CF;&#x25CF;
                                                                                    &#x25CF;&#x25CF;&#x25CF;&#x25CF; </span>
                                                                                <div class="date"><span class="date_value">MM / YYYY</span>
                                                                                </div>
                                                                            ...
                                                                            <div class="back">
                                                                                ...
                                                                                <span class="chip"></span><span class="disclaimer">This card is property
                                                                                    of Random Bank of Random corporation.
                                                                                    <br> If found please return to Random
                                                                                    Bank of Random corporation - 21968
                                                                                    Paris, Verdi Street, 34 </span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col2">
                                                                        <form id="form-cartao" method="post">
                                                                            <h4 style="text-align: center;"><strong>Dados do
                                                                                    cartão</strong></h4>
                                                                            <div>
                                                                                <label>Selecione a bandeira</label><br />
                                                                                <select name="brand">
                                                                                    <option value="visa" seleted>Visa
                                                                                    </option>
                                                                                    <option value="mastercard">MasterCard
                                                                                    </option>
                                                                                    <option value="diners">Dinners</option>
                                                                                    <option value="amex">AmericanExpress
                                                                                    </option>
                                                                                    <option value="elo">Elo</option>
                                                                                    <option value="hipercard">Hipercard
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                            <label>Número do cartão</label>
                                                                            <input class="number form-group" type="text" name="c_number" ng-model="ncard" required maxlength="19" onkeypress='return event.charCode >= 48 && event.charCode <= 57' />
                                                                            <label>Nome como impresso no cartão</label>
                                                                            <input class="inputname form-group" name="" type="text" placeholder="" required />
                                                                            <label>Validade</label>
                                                                            <input class="expire form-group" pattern="(\d{2}\s+\/\s+\d{4})|(\d{2}\/\d{4})" type="text" placeholder="MM/YYYY" name="expiration" required />
                                                                            ...
                                                                            <label>Nome</label>
                                                                            <input type="text form-group" name="name" required />
                                                                            <label>CPF <sup>(sem pontos, vírgulas ou
                                                                                    hífen)</sup></label>
                                                                            <input type="number" name="cpf" maxlength="11" required />
                                                                            <label>Data de nascimento</label>

                                                                            <input type="date" placeholder="DD/MM/YYYY" name="birth" required class="datechk" />

                                                                            <label>Email</label>
                                                                            <input type="email" name="email" required id="email" />
                                                                            <button class="buy btn-pagar">Pagar
                                                                                Agora</button>
                                                                        </form>
                                                                    </div>
                                                                </div>
                                                                <p class="textadj" style="font-size: 12px; padding-top: 2px;">
                                                                    Pagamento intermediado por Gerencianet
                                                                ...
                                                                <h2 style="float: left !important">Total:</h2>
                                                                <h2 style="float: right !important"><strong>R$
                                                                        <?php echo money($total); ?></strong></h2>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <script>
                                                    ...
                                                    $gn.ready(function(checkout) {
                                                        ...
                                                        const formCartaoCredito = document.getElementById(
                                                            'form-cartao');
                                                        ...
                                                        formCartaoCredito.addEventListener('submit', event => {
                                                            ...
                                                            $('.buy').html(
                                                                'Processando, aguarde um instante...').attr(
                                                                'disabled', true)
                                                            try {
                                                                const {
                                                                    c_number,
                                                                ...
                                                                const [mes, ano] = expiration.value.split('/')
                                                                    .map(el => el.trim());
                                                                var callback = function(error, response) {
                                                                    if (error) {
                                                                        ...
                                                                        $.ajax({
                                                                            url: `${baseUrl}gerencianet_gateway/gerencia_net/gerar_cartao_credito/${invoice_id}/${hash}`,
                                                                            data: {
                                                                                nome_cliente: name
                                                                                    .value,
                                                                                cpf: cpf.value,
                                                                                payament_token: response
                                                                                    .data
                                                                                    .payment_token,
                                                                                birth: birth.value,
                                                                                email: email.value
                                                                                ...
                                                                                if (resposta
                                                                                    ...
                                                                                    if (resposta
                                                                                        ...
                                                                                        if (resposta
                                                                                            ...
                                                                                            alert
                                                                                                (
                                                                                                    'Ops! Não foi possível realizar esta operação.');
                                                                                        }
                                                                                    }
                                                                                }
                                                                            },
                                                                ...
                                                                checkout.getPaymentToken({
                                                                    brand: brand.options[brand
                                                                            .selectedIndex]
                                                                        .value, // bandeira do cartão
                                                                    number: +c_number.value.toString()
                                                                        .replace(/\D+/g,
                                                                            ""), // número do cartão
                                                                    cvv: cvv.value
                                                                        .toString(), // código de segurança
                                                    ...
                                                    document.addEventListener("DOMContentLoaded", function() {
                                                        ...
                                                        $(function() {
                                                            ...
                                                            $(document).click(function(e) {
                                                                ...
                                                                if (!$(e.target).is(".expire") || !$(e
                                                                        .target).closest(".expire")
                                                                    .length) {
                                                                    $(".date_value").css("color",
                                                                        "var(--text-color)");
                                                                }
                                                                if (!$(e.target).is(".number") || !$(e
                                                                        .target).closest(".number")
                                                                    .length) {
                                                                    $(".card_number").css("color",
                                                                        "var(--text-color)");
                                                                }
                                                                if (!$(e.target).is(".inputname") || !$(
                                                                        e.target).closest(".inputname")
                                                                    .length) {
                                                                    $(".fullname").css("color",
                                                                        "var(--text-color)");
                                                                }
                                                            ...
                                                            $(".number").keyup(function(event) {
                                                                ...
                                                                if (parseInt(number.substring(0, 2)) >
                                                                    50 && parseInt(number.substring(0,
                                                                        2)) < 56) {
                                                                    selected_card = 0;
                                                                } else if (parseInt(number.substring(0,
                                                                        1)) == 4) {
                                                                    selected_card = 1;
                                                                } else if (parseInt(number.substring(0,
                                                                        2)) == 36 || parseInt(number
                                                                        .substring(0, 2)) == 38 ||
                                                                    parseInt(number.substring(0, 2)) ==
                                                                    39) {
                                                                    selected_card = 2;
                                                                } else if (parseInt(number.substring(0,
                                                                        2)) == 34 || parseInt(number
                                                                        .substring(0, 2)) == 37) {
                                                                    selected_card = 3;
                                                                } else if (parseInt(number.substring(0,
                                                                        2)) == 65) {
                                                                ...
                                                                if (selected_card != -1) {
                                                                    html.setAttribute("style",
                                                                        "--card-color: " + cards[
                                                                            selected_card].colore);
                                                                    $(".bankid").attr("src", cards[
                                                                        selected_card].src).show();
                                                                } else {
                                                                    html.setAttribute("style",
                                                                        "--card-color: #cecece");
                                                        ...
                                                        <div data-cy="bankSlipContent" id="bank-slip" class="sc-gGiJkG jzdkxv">
                                                            ...
                                                            <ul>
                                                                <li class="sc-bWNSNh ijsSky how-to">
                                                                    ...
                                                                    </svg><span>Imprima o boleto e <strong>pague no
                                                                            banco</strong></span>
                                                                </li>
                                                                <li class="sc-bWNSNh ijsSky how-to">
                                                                    ...
                                                                    </svg><span><strong>ou pague pela internet</strong>
                                                            ...
                                                            <div style="margin-top: 30px !important">
                                                                ...
                                                                <button class="btn btn-info btn-block btn-pagar" form="form-pagamento">Gerar boleto</button>
    ...
    <?php echo form_open_multipart(null, ['id' => 'form-pagamento']); ?>
