                                                ...
                                                <script>
                                                    window.addEventListener('load', function() {
                                                        ...
                                                        if (pixAtivo) {
                                                            ...
                                                            $.post(`${baseUrl}gerencianet_gateway/gerencia_net/gerar_pix_por_javascript/${invoice_id}/${hash}`, function(response) {
                                                                try {
                                                                    ...
                                                                    setTimeout(() => {
                                                                        setInterval(() => {
                                                                            $.get(`<?php echo base_url() ?>gerencianet_gateway/gerencia_net/callback_check_pix_pago/${txid}/${invoice_id}`, function(response) {
                                                                                if (response == '1') {
