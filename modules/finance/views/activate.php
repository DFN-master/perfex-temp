         ...
         <div class="col-md-6 col-md-offset-3">
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  Ative seu produto usando sua chave de compra de licença (<a target="_blank" href="https://cp.diletec.com.br">onde posso encontrar minha chave de compra?</a>)
                  <br><br>
                  ...
                  <?php
                    (get_option('module_finance_purchase_key')? $purchase_key = get_option('module_finance_purchase_key') : $purchase_key = '');
                    echo render_input('purchase_key', 'purchase_key', $purchase_key, 'text', ['required' => true]);
                  ?>
