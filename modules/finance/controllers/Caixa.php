...
class Caixa extends AdminController
{
    public function index()
    {
         ...
         * method Caixa
         */
        if(Caixa::license() == false){ echo 'Entre em contato com o suporte da Diletec.'; return false;}
        $data["license"] =  Caixa::license();
        $CI = &get_instance();
