                        ...
                        <div class="form-group" app-field-wrapper="description">
                            ...
                            <div class="col-md-12" style="margin-bottom: 15px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 client_user_type" style="padding-bottom: 3px;margin-left: 50px;">
                                        <div class="radio radio-primary radio-inline input_radio">
                                            <div>
                                                <input type="radio" id="clients_both" name="c_user_type" <?php if ($form_details->c_user_type == 'both') echo 'checked'; ?> value="both">
                                                <label for="clients_both"><?php echo 'Both' ?></label>
                                            </div>
                                            <div>
                                                <input type="radio" id="clients_logged_in" name="c_user_type" <?php if ($form_details->c_user_type == 'logged_in') echo 'checked'; ?> value="logged_in">
                                                <label for="clients_logged_in"><?php echo 'Logged in users' ?></label>
                                            </div>
                                            <div>
                                                <input type="radio" id="clients_not_logged_in" name="c_user_type" <?php if ($form_details->c_user_type == 'not_logged_in') echo 'checked'; ?> value="not_logged_in">
                                                <label for="clients_not_logged_in"><?php echo 'Not Logged in users' ?></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
...
$(function() {
    ...
    $(document).on('click', '#save_changes', function() {
        ...
        var field_data = {
            ...
            c_user_type: $("input[name='c_user_type']:checked").val(),
            status: $("#status").val(),
            code: custom_css,
            code_type: codeType,
    ...
    // Hide and show client area user type options. Only show when clients area location is selected
    if($('input[type=radio][name=area_type]:checked').val() == 'clients') {
        $('.client_user_type').show();
    } else {
        $('.client_user_type').hide();  
    }
    $('input[type=radio][name=area_type]').change(function() {
