<script>
   ...
   (function($) {
    ...
    "use strict";
      ...
      {
        $( "#dowload_file_sample" ).append( '<a href="'+ site_url+'modules/okr/uploads/file_sample/import_okr_sample_en.xlsx" class="btn btn-primary" ><?php echo _l('download_sample') ?></a><hr>' );
...
function uploadfilecsv(event){
  "use strict";
    ...
    $.ajax({
      url: admin_url + 'okr/import_okr_data',
      method: 'post',
      data: formData,
      contentType: false,
      processData: false
