				 	...
				 	<div class="horizontal-scrollable-tabs preview-tabs-top">
					  <div class="horizontal-tabs">
					      ...
					      <li role="presentation">
					      	<a href="#tab_tasks" onclick="init_rel_tasks_table(<?php echo okr_html_entity_decode($id); ?>,'okrs'); return false;" aria-controls="tab_tasks" role="tab" data-toggle="tab" data-id="<?php echo okr_html_entity_decode($id); ?>" class="task-func"><?php echo _l('tasks'); ?></a>
					      </li>
