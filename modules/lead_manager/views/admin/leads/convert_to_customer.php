...
<div class="modal fade" id="convert_lead_to_client_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
   <div class="modal-dialog modal-lg" role="document">
      <?php echo form_open('admin/lead_manager/convert_to_customer',array('id'=>'lead_to_client_form')); ?>
      <div class="modal-content">
         ...
         <div class="modal-body">
           ...
           <?php echo form_hidden('converted_by_lead_manager',1); ?>
           <?php
...
<div class="modal-footer">
   <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo _l('back_to_lead'); ?></button>
