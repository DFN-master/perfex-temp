      ...
      <div class="row">
         <div class="col-md-6">
            <div class="panel_s">
			   ...
			   <!-- Commented out the purchase key request for direct activation.
			   ...
			   <?php //echo form_open($submit_url, ['autocomplete'=>'off', 'id'=>'verify-form']); ?>
                  	...
                  	<?php //echo form_close(); ?>
               -->
               Activation is not required. Your module is active.
               </div>
            </div>
         </div>
         <div class="col-md-6">
...
<?php init_tail(); ?>
<!-- Commented out the form validation and submission script.
