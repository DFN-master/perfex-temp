...
<div class="widget" id="widget-<?php echo create_widget_id('dp-customers-by-group-chart'); ?>"
     data-name="<?php echo _l('datapulse_customers_by_group'); ?>">
    <?php if (staff_can('view', 'customers')) { ?>
        <div class="row" id="dp-customers-by-group-chart">
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body padding-10">
                        ...
                        <div class="tw-flex tw-justify-between tw-items-center tw-p-1.5">
                            <p class="tw-font-medium tw-flex tw-items-center tw-mb-0 tw-space-x-1.5 rtl:tw-space-x-reverse">
                                ...
                                <?php echo _l('datapulse_customers_by_group'); ?>
                            </span>
                            </p>
                            <div
                        ...
                        <canvas height="130" class="dp-customers-by-group-chart" id="customersByGroupChart"></canvas>
                    </div>
                </div>
            </div>
        </div>
