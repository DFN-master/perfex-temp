...
<div class="widget" id="widget-<?php echo create_widget_id('dp-added-tickets-by-project-chart'); ?>"
     data-name="<?php echo _l('datapulse_added_tickets_by_project'); ?>">
    <?php if (staff_can('view', 'tickets')) { ?>
                    ...
                    <div class="panel-body padding-10">
                        ...
                        <div class="tw-flex tw-justify-between tw-items-center tw-p-1.5">
                            <p class="tw-font-medium tw-flex tw-items-center tw-mb-0 tw-space-x-1.5 rtl:tw-space-x-reverse">
                                ...
                                <?php echo _l('datapulse_added_tickets_by_project'); ?>
                            </span>
                            </p>
                            <div class="tw-divide-x tw-divide-solid tw-divide-neutral-300 tw-space-x-2 tw-flex tw-items-center">
                                <div class="dropdown pull-right mright10">
                                    <a href="#" class="dropdown-toggle tw-pl-2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <span id="dpAddedTicketsByProjectYear" data-active-chart="weekly">
                                            <?php echo date('Y'); ?>
                                        </span>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        ...
                                        for ($year = $currentYear; $year >= 2016; $year--) { ?>
                                            <li>
                                                <a href="#" data-year="<?php echo $year; ?>" onclick="dpAddedTicketsByProject(this); return false;">
                                                    <?php echo $year; ?>
                                                </a>
                                            </li>
                                        <?php } ?>
                        ...
                        <canvas height="130" id="addedTicketsByProjectChart"></canvas>
                    </div>
                </div>
            </div>
        </div>
