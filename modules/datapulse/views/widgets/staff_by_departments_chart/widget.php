...
<div class="widget" id="widget-<?php echo create_widget_id('dp-staff-by-departments'); ?>"
     data-name="<?php echo _l('datapulse_staff_by_departments'); ?>">
    <?php if (is_admin()) { ?>
                    ...
                    <div class="panel-body padding-10">
                        ...
                        <div class="tw-flex tw-justify-between tw-items-center tw-p-1.5">
                            <p class="tw-font-medium tw-flex tw-items-center tw-mb-0 tw-space-x-1.5 rtl:tw-space-x-reverse">
                                ...
                                <?php echo _l('datapulse_staff_by_departments'); ?>
                            </span>
                            </p>
                            <div
                        ...
                        <canvas height="130" class="dp-staff-by-departments" id="staffByDepartmentsChart"></canvas>
                    </div>
                </div>
            </div>
        </div>
