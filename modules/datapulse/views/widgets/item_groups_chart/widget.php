...
<div class="widget" id="widget-<?php echo create_widget_id('dp-item-groups-chart'); ?>"
     data-name="<?php echo _l('datapulse_item_groups_chart'); ?>">
    <?php if (staff_can('view', 'items')) { ?>
                    ...
                    <div class="panel-body padding-10">
                        ...
                        <div class="tw-flex tw-justify-between tw-items-center tw-p-1.5">
                            <p class="tw-font-medium tw-flex tw-items-center tw-mb-0 tw-space-x-1.5 rtl:tw-space-x-reverse">
                                ...
                                <?php echo _l('datapulse_item_groups_chart'); ?>
                            </span>
                            </p>
                            <div
                        ...
                        <canvas height="130" class="dp-item-groups-chart" id="dpItemGroupChart"></canvas>
                    </div>
                </div>
            </div>
        </div>
