...
<div class="widget" id="widget-<?php echo create_widget_id('dp-customers-through-year-chart'); ?>"
     data-name="<?php echo _l('datapulse_customers_through_year'); ?>">
    <?php if (staff_can('view', 'customers')) { ?>
        <div class="row" id="dp-customers-through-year-chart">
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body padding-10">
                        ...
                        <div class="tw-flex tw-justify-between tw-items-center tw-p-1.5">
                            <p class="tw-font-medium tw-flex tw-items-center tw-mb-0 tw-space-x-1.5 rtl:tw-space-x-reverse">
                                ...
                                <?php echo _l('datapulse_customers_through_year'); ?>
                            </span>
                            </p>
                            <div class="tw-divide-x tw-divide-solid tw-divide-neutral-300 tw-space-x-2 tw-flex tw-items-center">
                                <div class="dropdown pull-right mright10">
                                    <a href="#" class="dropdown-toggle tw-pl-2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <span id="customersThroughYearChartYear" data-active-chart="weekly">
                                            <?php echo date('Y'); ?>
                                        </span>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        ...
                                        for ($year = $currentYear; $year >= 2016; $year--) { ?>
                                            <li>
                                                <a href="#" data-year="<?php echo $year; ?>" onclick="dpCustomersThroughYear(this); return false;">
                                                    <?php echo $year; ?>
                                                </a>
                                            </li>
                                        <?php } ?>
                        ...
                        <canvas height="130" class="dp-customers-through-year-chart" id="customersThroughYearChart"></canvas>
                    </div>
                </div>
            </div>
        </div>
