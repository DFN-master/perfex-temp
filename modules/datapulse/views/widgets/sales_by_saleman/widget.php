...
$weekly_payment_stats = json_encode($this->dashboard_model->get_weekly_payments_statistics(1));
?>
<div class="widget" id="widget-<?php echo create_widget_id('dp-sales-by-saleman'); ?>"
     data-name="<?php echo _l('datapulse_sales_by_saleman'); ?>">
    <?php if (true) { ?>
                    ...
                    <div class="panel-body padding-10">
                        ...
                        <div class="tw-flex tw-justify-between tw-items-center tw-p-1.5">
                            <p class="tw-font-medium tw-flex tw-items-center tw-mb-0 tw-space-x-1.5 rtl:tw-space-x-reverse">
                                ...
                                <?php echo _l('datapulse_sales_by_saleman'); ?>
                            </span>
                            </p>
                            <div
                                ...
                                <div class="dropdown pull-right mright10">
                                    <a href="#" id="PaymentChartmode" class="dropdown-toggle tw-pl-2"
                        ...
                        <canvas height="130" class="sales-by-saleman" id="sales-by-saleman-widget"></canvas>
                    </div>
                </div>
            </div>
        </div>
