...
<div class="widget" id="widget-<?php echo create_widget_id('dp-customers-map-chart'); ?>"
     data-name="<?php echo _l('datapulse_customers_map_chart'); ?>">
                    ...
                    <div class="panel-body padding-10">
                        ...
                        <div class="tw-flex tw-justify-between tw-items-center tw-p-1.5">
                            <p class="tw-font-medium tw-flex tw-items-center tw-mb-0 tw-space-x-1.5 rtl:tw-space-x-reverse">
                                ...
                                <?php echo _l('datapulse_customers_map_chart'); ?>
                            </span>
                            </p>
                        </div>
                        <hr class="-tw-mx-3 tw-mt-2 tw-mb-4">
                        <div id="regions_div" style="max-width: 100%; height: 100%;"></div>
                    </div>
                </div>
            </div>
        </div>
