 ...
 *   $fileStoreDataProfiles = $dlpService->projects_locations_fileStoreDataProfiles;
 *  </code>
 */
class ProjectsLocationsFileStoreDataProfiles extends \Google\Service\Resource
{
  /**
   ...
   * (fileStoreDataProfiles.listProjectsLocationsFileStoreDataProfiles)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsFileStoreDataProfiles($parent, $optParams = [])
  {
...
class_alias(ProjectsLocationsFileStoreDataProfiles::class, 'Google_Service_DLP_Resource_ProjectsLocationsFileStoreDataProfiles');
