 ...
 *   $sessions = $discoveryengineService->projects_locations_dataStores_sessions;
 *  </code>
 */
class ProjectsLocationsDataStoresSessions extends \Google\Service\Resource
{
  /**
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsDataStoresSessions($parent, $optParams = [])
  {
...
class_alias(ProjectsLocationsDataStoresSessions::class, 'Google_Service_DiscoveryEngine_Resource_ProjectsLocationsDataStoresSessions');
