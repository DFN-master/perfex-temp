 ...
 *   $controls = $discoveryengineService->projects_locations_collections_dataStores_controls;
 *  </code>
 */
class ProjectsLocationsCollectionsDataStoresControls extends \Google\Service\Resource
{
  /**
   ...
   * (controls.listProjectsLocationsCollectionsDataStoresControls)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsCollectionsDataStoresControls($parent, $optParams = [])
  {
...
class_alias(ProjectsLocationsCollectionsDataStoresControls::class, 'Google_Service_DiscoveryEngine_Resource_ProjectsLocationsCollectionsDataStoresControls');
