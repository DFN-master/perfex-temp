 ...
 *   $answers = $discoveryengineService->projects_locations_collections_dataStores_sessions_answers;
 *  </code>
 */
class ProjectsLocationsCollectionsDataStoresSessionsAnswers extends \Google\Service\Resource
{
  /**
...
class_alias(ProjectsLocationsCollectionsDataStoresSessionsAnswers::class, 'Google_Service_DiscoveryEngine_Resource_ProjectsLocationsCollectionsDataStoresSessionsAnswers');
