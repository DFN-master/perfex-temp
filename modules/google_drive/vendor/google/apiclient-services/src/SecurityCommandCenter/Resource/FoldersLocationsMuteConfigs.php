...
class FoldersLocationsMuteConfigs extends \Google\Service\Resource
{
  ...
  /**
   * Lists mute configs. (muteConfigs.listFoldersLocationsMuteConfigs)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listFoldersLocationsMuteConfigs($parent, $optParams = [])
  {
...
class_alias(FoldersLocationsMuteConfigs::class, 'Google_Service_SecurityCommandCenter_Resource_FoldersLocationsMuteConfigs');
