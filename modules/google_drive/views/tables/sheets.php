...
$where              = [
    'AND ' . db_prefix() . 'google_drives.type = \'sheet\''
];
...
foreach ($rResult as $aRow) {
    ...
    if (staff_can('edit', 'google_drive')) {
        $options .= '<a href="#" class="tw-text-neutral-500 hover:tw-text-neutral-700 focus:tw-text-neutral-700" data-toggle="modal" data-target="#google_drive_sheet_modal" data-id="' . $aRow['id'] . '">
