...
class Client_merge_fields extends App_merge_fields
{
    ...
    public function format($client_id, $contact_id = '', $password = '')
    {
        ...
        $fields['{customer_profile_files_2_admin_link}'] = admin_url('clients/client/' . $client->userid . '?group=attachments_2');
        $fields['{customer_profile_files_3_admin_link}'] = admin_url('clients/client/' . $client->userid . '?group=attachments_3');
        $fields['{customer_profile_files_4_admin_link}'] = admin_url('clients/client/' . $client->userid . '?group=attachments_4');
        $fields['{customer_profile_files_5_admin_link}'] = admin_url('clients/client/' . $client->userid . '?group=attachments_5');
